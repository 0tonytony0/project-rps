...
function displayWinner(results){
    setTimeout(() => {
        ...
        if(userwins){
            ...
            keepscore1(1)
            btn_next.classList.add("show-next");
...
playAgainBtn.addEventListener("click", () => {
    ...
    btn_next.classList.remove("show-next");
...
btn_next.addEventListener("click", () => {
    hurray_page.classList.toggle("hidden");
    main_page.classList.toggle("hidden");
});

//hurray page

const playAgainBtn2 = document.querySelector(".play-again-2");
